/*
 	...
 	Alice wants to erase some of its letters to make it harmonic. Alice asked for her help to 
 	write a program that informs the largest length of the resulting string after she erases 
 	some of its letters, to make it harmonic. Consider that the entry will contain only 
